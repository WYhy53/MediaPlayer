package com.coolweather.musicplayer;
...
public class MusicService extends Service {
    ...
    //MusicService类的无参构造函数中实例化对象，并把这些MP3文件放到musicList中
    public MusicService() {
        super();
    ...
    //写一个方法来修改获取到的MP3文件的名字供我们在TextView页面中使用
    ...
    public void play() {
        try {
            ...
            player.setAudioStreamType(AudioManager.STREAM_MUSIC);// 指定参数为音频文件
